...
> This file is read by GitHub Copilot, Gemini CLI, Kiro, and other AI agents that support AGENTS.md.
...
If this project has a `CLAUDE.md`, `.cursor/rules/`, or `.kiro/steering/` directory, those take precedence.
...
Follow the conventions in `.claude/rules/`, `.cursor/rules/`, or `.kiro/steering/` for this language.
